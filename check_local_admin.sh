...
### CHANGES: Fixed domain check loop, corrected logic for recurvise group membership (nesting group within group),
### fixed issue where poorly named domain (eg: OU) could cause the script to return false positives on local accounts.
